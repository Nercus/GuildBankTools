...
---@class FramePool<T>: { Acquire: fun(self: FramePool<T>): T}, { Release: fun(self: FramePool<T>, obj: T): boolean}, { ReleaseAll: fun(self: FramePool<T>)}, { EnumerateActive: fun(self: FramePool<T>) }
